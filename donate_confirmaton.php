...
<head>
    ...
    <title><?php echo $payment_success ? 'Thank You for Your Donation' : 'Donation Status'; ?> - Faith Baptist Church
    </title>
...
<body>
    ...
    <section class="page-banner"
        style="background-image: url('images/WhatsApp Image 2025-02-25 at 08.09.51_39099767.jpg'); background-size: cover; background-position: center; height: 300px; display: flex; align-items: center; position: relative;">
        ...
        <div class="container" style="position: relative; z-index: 1;">
            <div style="text-align: center; color: white;">
                <h1 style="font-size: 42px; margin-bottom: 15px;">
                    <?php echo $payment_success ? 'Thank You for Your Donation' : 'Donation Status'; ?></h1>
                <div>
                    <a href="index.html" style="color: white; transition: color 0.3s;">Home</a>
            ...
            <div class="donation-card">
                <?php if ($payment_success && !empty($donation_data)): ?>
                    <div class="donation-success">
                        ...
                        <p style="margin-bottom: 20px;">Your generous contribution helps us continue our mission and serve
                            our community. A confirmation email has been sent to your registered email address with the
                        ...
                        <p style="margin-bottom: 20px;">If you have any questions about your donation, please contact our
                            church office.</p>
                ...
                <?php else: ?>
                    <div class="donation-success">
                        ...
                        <p style="margin-bottom: 20px;">
                            <?php echo !empty($payment_error) ? $payment_error : 'There was an issue processing your donation. Please try again or contact our church office for assistance.'; ?>
                        </p>

                        <div style="margin-bottom: 20px;">
                            <a href="donate.html" class="btn btn-primary">Try Again</a>
                            <a href="index.html" class="btn btn-outline" style="margin-left: 10px;">Return to Homepage</a>
                        </div>
                    </div>
                <?php endif; ?>
            </div>
        ...
        <div class="container">
            <div class="footer-content">
                ...
                <div class="footer-services">
                    <h5>Service Times</h5>
                    <ul>
                        <li><a href="index.html#services">Sunday: 8:00 AM - 11:00 AM</a></li>
                        <li><a href="index.html#services">Wednesday: 7:00 PM - 9:00 PM</a></li>
                        <li><a href="index.html#services">Friday: 7:00 PM - 9:00 PM</a></li>
                    </ul>
                </div>
