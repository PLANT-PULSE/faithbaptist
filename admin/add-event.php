...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        $stmt = $conn->prepare("INSERT INTO events (title, description, event_date, event_time, location, image, is_featured) VALUES (?, ?, ?, ?, ?, ?, ?)");
        $stmt->bind_param("ssssssi", $title, $description, $event_date, $event_time, $location, $image_filename, $is_featured);
...
<head>
    ...
    <title>Add Event - Faith Baptist Church</title>
            ...
            <div class="card-body">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" id="event_date" name="event_date" required value="<?php echo $_POST['event_date'] ?? ''; ?>">
                    </div>
                    
                    <div class="form-group">
                        <label for="event_time">Event Time</label>
                        <input type="time" id="event_time" name="event_time" required value="<?php echo $_POST['event_time'] ?? ''; ?>">
                    </div>
